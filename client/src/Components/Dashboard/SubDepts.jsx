...
import DepartmentInfo from "../DepartmentSections/DepartmentInfo";
export default function SubDepts({ category2 }) {
  ...
  if (category2 == "all") {
    return (
      <div className="py-2 px-3 md:py-8 md:px-12 relative">

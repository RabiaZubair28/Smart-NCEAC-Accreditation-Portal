...
const CourseDetails2 = () => {
  ...
  const handleAddQuestiontoAssessment = async (e, assessmentId) => {
    ...
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/assessments/add-question/${params.id}/${assessmentId}`,
        {
          method: "POST",
  ...
  const handleDeleteQuestionFromAssessment = async (
    ...
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/assessments/delete-question/${assessmentId}/${questionId}`,
        {
          method: "DELETE",
          headers: { "Content-Type": "application/json" },
        }
  ...
  const handleDeletePrerequisites = async () => {
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/data/course/id/${params.id}/prerequisites`,
        { method: "PUT" }
      );
  ...
  const handleAddCLO = async () => {
    ...
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/data/course/${params.id}/add-clo`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
  ...
  const handleEditCLO = (index) => {
    ...
    fetch(`https://iba-nceac.onrender.com/api/data/course/${params.id}/clo`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        index,
  ...
  const handleDeleteCLO = async (index) => {
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/data/course/${params.id}/delete-clo`,
        {
          method: "DELETE",
          headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://iba-nceac.onrender.com/api/assessments/addAssessment",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const handleEditAssessment = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/assessments/${assessmentToEdit._id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
    ...
    const fetchDepartment = async () => {
      try {
        const res = await axios.get(
          `https://iba-nceac.onrender.com/api/data/department/${departmentId}`
        );
  ...
  const handleEditQuestionInAssessment = async (
    ...
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/assessments/${assessmentId}/questions/${questionId}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const handleDeleteAssessment = async (courseId, assessmentId) => {
    try {
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/assessments/deleteAssessment/${courseId}/${assessmentId}`,
        { method: "DELETE" }
      );
  ...
  useEffect(() => {
    if (courseInfo?.departmentId) {
      const getBatches = async () => {
        try {
          const response = await fetch(
            `https://iba-nceac.onrender.com/api/batches/all-batches/${courseInfo.departmentId}`,
            { method: "GET" }
          );
    ...
    try {
      const results = await Promise.allSettled(
        selectedStudents.map((studentId) =>
          fetch(
            `https://iba-nceac.onrender.com/api/students/${studentId}/add-course`,
            {
              method: "PUT",
              headers: { "Content-Type": "application/json" },
      ...
      <div className="p-6">
        ...
        {showModalAdd02 && (
          <div className="fixed inset-0 flex items-center justify-center  bg-black bg-opacity-50  z-50">
            <div className="bg-white px-6 pt-4 pb-6 rounded-lg shadow-lg w-[40%]">

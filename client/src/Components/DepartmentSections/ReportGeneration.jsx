  ...
  const getCourseInfo = async (id) => {
    try {
      ...
      const response = await fetch(
        `https://iba-nceac.onrender.com/api/data/course/id/${courseId}`,
        { method: "GET" }
      );
      if (response.ok) {
    ...
    const fetchData = async () => {
      try {
        ...
        const [studentsRes, batchesRes] = await Promise.all([
          ...
          axios.get(
            `https://iba-nceac.onrender.com/api/batches/all-batches/${departmentId}`
          ),
        ]);
              ...
              student.courses.map(async (course) => {
                try {
                  ...
                  const courseRes = await axios.get(
                    `https://iba-nceac.onrender.com/api/data/course/id/${courseIdString}`
                  );

...
function ElearningWorksheets() {
  return (
    <div className="bg-[#f7f9fa] py-2 sm:py-4 lg:pt-2 lg:pb-12 px-4 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center p-4 sm:p-8 lg:p-12">
          ...
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
              Enable real-time analysis and feedback, ensuring timely
              adjustments and improvements in educational programs.
            </p>

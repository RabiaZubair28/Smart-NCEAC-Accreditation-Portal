  ...
  return (
    ...
    >
      <div className="max-w-[1800px] mx-auto px-5 md:px-5 flex justify-between items-center py-3">
        ...
        <div className="flex md:space-x-2 space-x-2 items-center justify-center">
          <div
            className="flex items-center justify-center bg-[#1F2C73] text-white px-5 py-2 rounded-md cursor-pointer"
            onClick={() => {
